...
<head>
	...
	window.onload = function () {
		...
		var sArray = <?php echo json_encode($solvedCounts);?>
		...
		var sArray2 = <?php echo json_encode($solvedCounts2);?>;
		...
		for(var i=0;i<sArray2.length;i++){
			chart5.options.data[1].dataPoints.push({ y: parseInt(sArray2[i]), label: jArray2[i]}); // Add a new dataPoint to dataPoints array
		}
		chart5.render();
		///new chart
		...
		for(var i=0;i<sArray.length;i++){
			chart4.options.data[1].dataPoints.push({ y: parseInt(sArray[i]), label: jArray[i][1]}); // Add a new dataPoint to dataPoints array
		}
		console.log(sArray.length, jArray1.length);
		chart4.render();
